...
public class V8LogScannerData implements Serializable {
    ...
    public enum ScannerCommands {
        GET_LOG_FILES_FROM_CFG, EXECUTE_RGX_OP, SELECT_RGX_RESULT,
        GET_PROC_INFO, GET_RGX_INFO, PATH_EXIST, RESET_RESULT, RESET_ALL, READ_CFG_PATHS, WRITE_CFG_FILE, DELETE_CFG_FILE, GET_CFG_PATHS
    }
