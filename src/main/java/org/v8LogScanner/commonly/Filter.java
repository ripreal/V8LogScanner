...
public abstract class Filter<T1> implements Iterable<T1>, Serializable {
  ...
  public ComparisonTypes getComparisonType() {return comparisonType;};
  public void setComparisonType(ComparisonTypes comparisonType){this.comparisonType = comparisonType;};
  ...
  public boolean isActive() {return elements.size()>0;};

  public void reset() {elements.clear();};

  public int size() {return elements.size();};

  public T1 get(int index) {return elements.get(index);};

  public Iterator<T1> iterator() {return elements.iterator();};
